...
namespace ARMApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            .AddJwtBearer("JwtBearer", jwtBearerOption =>
            {
                jwtBearerOption.TokenValidationParameters = new TokenValidationParameters
                {
                    ...
                    IssuerSigningKey = new SymmetricSecurityKey(Encoding.UTF8.GetBytes("MySecretKeyIsSecretSoDoNoteTell")),
            ...
            services.AddSwaggerGen(setup =>
            {
                setup.SwaggerDoc(
                    ...
                    new OpenApiInfo
                    {
                        Title = "Alcheman Retail Manager API",
                        Version = "v1",
                    }
                    );
            });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(x =>
            {
                x.SwaggerEndpoint("/swagger/v1/swagger.json", "Alcheman API v1");
            });
